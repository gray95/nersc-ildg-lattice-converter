...
Included in this repo is a Grid program that can read Nersc format lattices andwrite them out in reduced Ildg format while conforming to Ildg's Binary spec rev 1.2. 

## Building the Program

Included is a shell script, courtesy of Ryan Hill, that generates a basic Grid application.
